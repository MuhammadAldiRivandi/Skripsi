...
%=============================================================================
\namanpm{Muhammad Aldi Rivandi}{6182001029}
...
%=============================================================================
\judulINA{Modularisasi Algoritma Shortest Path pada Perangkat Lunak KIRI Menggunakan Strategy Pattern}
\judulENG{Modularization of the Shortest Path Algorithm on KIRI Software Using Strategy Pattern}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
% - langsung mulai setelah '{' awal, jangan mulai menulis di baris bawahnya
%=============================================================================
\abstrakINA{Perangkat lunak KIRI merupakan aplikasi pencari rute transportasi publik yang arsitekturnya dibagi menjadi dua, yaitu Tirtayasa (\textit{frontend}) dan NewMenjangan (\textit{backend}). Saat ini Perangkat Lunak KIRI hanya memanfaatkan algoritma Dijkstra untuk perhitungan jalur terpendek. Penelitian ini bertujuan untuk mengembangkan perangkat lunak KIRI dengan menerapkan strategy pattern sebagai pendekatan modularisasi algoritma \textit{shortest path}. Dengan penerapan \textit{strategy pattern}, penambahan algoritma \textit{shortest path} lainnya dapat dilakukan secara dinamis tanpa mengubah struktur kode utama.
\\
Pada penelitian ini, akan ditambahkan atau diimplementasikan dua algoritma shortest path lainnya, yaitu Floyd-Warshall dan A-Star, yang dikembangkan dan diintegrasikan ke dalam \textit{backend} KIRI sebagai strategi alternatif. Algoritma Floyd-Warshall dipilih karena kemampuannya dalam menghitung semua pasangan titik, sedangkan A-Star digunakan karena keunggulannya dalam efisiensi pencarian pada graf berbobot yang besar dan memiliki nilai heuristik lokasi.
\\
Hasil pengujian menunjukkan bahwa modularisasi dengan \textit{strategy pattern} meningkatkan fleksibilitas dalam pengelolaan algoritma pencarian jalur terpendek, serta memudahkan penambahan atau penggantian algoritma apabila akan dilakukan pemeliharaan atau pengambangan lebih lanjut. Selain itu, masing-masing algoritma menunjukkan performa yang berbeda sesuai dengan karakteristik graf dan skenario pencarian yang diuji, sehingga memberikan opsi lebih bagi pengguna dan pengembang sistem.}
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{shortest path, strategy pattern, Dijkstra, Floyd-Warshall, A-Star, perangkat lunak KIRI, modularisasi}
\kunciENG{shortest path, strategy pattern, Dijkstra, Floyd-Warshall, A-Star, KIRI software, modularization}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\untuk{Tugas Akhir ini dipersembahkan untuk Tuhan Yang Masa Esa, keluarga, dosen-dosen, dan teman-teman mahasiswa}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\prakata{Puji syukur dipanjatkan kepada Tuhan Yang Maha Esa karena atas rahmat dan karunia beserta izinNya, penulis dapat menyelesaikan penulisan tugas akhir yang berjudul "Modularisasi Algoritma Shortest Path pada Perangkat Lunak KIRI Menggunakan Strategy Pattern". Penulis juga ingin mengucapkan terima kasih kepada pihak-pihak yang senantiasa memberikan dukungan serta bantuan selama pengerjaan tugas akhir ini. Penulis ingin mengucapkan terima kasih kepada:
\begin{enumerate}
    \item Orang tua dan keluarga yang senantiasa memberikan dukungan, doa, motivasi, dan semangat selama pengerjaan tugas akhir ini.
    \item Bapak Pascal Alfadian Nugroho, M.Comp. selaku dosen pembimbing yang senantiasa memberikan bimbingan, motivasi, dan waktunya dari awal hingga selesai sehingga tugas akhir ini dapat diselesaikan dengan baik.
    \item Ibu Rosa De Lima, M.T. dan ... selaku dosen penguji yang telah memberikan kritik dan saran yang membangun.
    \item Teman-teman yang senantiasa memberikan dukungan dan semangat, baik teman-teman mahasiswa UNPAR ataupun teman-teman lainnya.
    \item Seluruh dosen serta staf dari Teknik Informatika UNPAR yang senantiasa memberikan bantuan dalam berbagai hal dari awal perkuliahan.
\end{enumerate}
\noindent
